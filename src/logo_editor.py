...
_LEGACY_BOARDS = [
    ...
    {"id": "pbdisplay", "name": "Push Button Display", "description": "Triggered automatically by a physical push-button input — do not add to rotation.", "kind": "legacy", "system": True},
    {"id": "weather", "name": "Weather", "description": "Current local weather conditions for the configured location", "kind": "legacy"},
    {"id": "wxalert", "name": "Weather Alerts", "description": "Auto-interrupts the rotation when severe weather hits — do not add to rotation manually.", "kind": "legacy", "system": True},
    {"id": "wxforecast", "name": "Weather Forecast", "description": "Multi-day weather forecast for the configured location", "kind": "legacy"},
    {"id": "screensaver", "name": "Screensaver", "description": "Quiet-hours idle mode (random GIF then panel fade-to-black). Triggered automatically — do not add to rotation; it loops forever and will lock the matrix.", "kind": "legacy", "system": True},
